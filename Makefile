...
default: 
	...
	@echo "${COLOR_DEFAULT}> ${COLOR_GREEN}run${COLOR_DEFAULT}            |-----------------------------------------|  ${COLOR_DEFAULT_BOLD_ITALIC}Down, Build and Up Docker images${COLOR_RESET}"
	...
	@echo "${COLOR_DEFAULT}> ${COLOR_GREEN}logs-pgadmin${COLOR_DEFAULT}   |-----------------------------------------|  ${COLOR_DEFAULT_BOLD_ITALIC}Show Logs with Pgadmin logs${COLOR_RESET}"
# ssh:
